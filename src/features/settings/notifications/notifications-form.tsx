          ...
          <div className='space-y-4'>
              ...
              render={({ field }) => (
                <FormItem className='flex flex-row items-center justify-between rounded-lg border p-4'>
                  <div className='space-y-0.5'>
                    <FormLabel className='text-base'>账户沟通邮件</FormLabel>
                    <FormDescription>
                      接收与你的账户活动相关的邮件通知。
                    </FormDescription>
                  </div>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className='flex flex-row items-center justify-between rounded-lg border p-4'>
                  <div className='space-y-0.5'>
                    <FormLabel className='text-base'>社交通知邮件</FormLabel>
                    <FormDescription>
                      接收好友请求、关注动态等社交提醒邮件。
                    </FormDescription>
                  </div>
          ...
          render={({ field }) => (
            <FormItem className='relative flex flex-row items-start'>
              ...
              <div className='space-y-1 leading-none'>
                <FormLabel>为移动设备使用不同的通知设置</FormLabel>
                <FormDescription>
                  当前移动端通知偏好仍通过{' '}
                  <Link
                    to='/settings'
