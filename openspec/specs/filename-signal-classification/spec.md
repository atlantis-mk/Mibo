# filename-signal-classification Specification

## Purpose
Define structured filename signal extraction, bounded directory summaries, and lightweight evidence used by fast media classification before cleaned title views or authoritative technical metadata are produced.
