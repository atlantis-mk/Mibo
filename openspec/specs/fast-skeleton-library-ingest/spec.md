# fast-skeleton-library-ingest Specification

## Purpose

Define fast library ingest behavior that makes newly discovered video files visible from inventory-backed skeleton entries before expensive classification and enrichment completes.
