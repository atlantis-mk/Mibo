# person-detail-experience Specification

## Purpose
Define the dedicated catalog person detail experience, including navigation from media detail people cards, person-first profile presentation, related local works, external references, and API data needs.
