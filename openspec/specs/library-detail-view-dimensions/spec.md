# library-detail-view-dimensions Specification

## Purpose

Define tabbed library detail dimensions and bounded states for dimensions that are not yet backed by reliable data.
