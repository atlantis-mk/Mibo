# health-center-diagnostics Specification

## Purpose
Define structured health diagnostics, user-facing health issue surfaces, and recovery guidance for media source, library, job, and dependency problems.
