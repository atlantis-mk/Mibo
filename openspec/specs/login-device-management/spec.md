# login-device-management Specification

## Purpose
Define authenticated login device management so users can review and revoke their own login sessions from settings.
