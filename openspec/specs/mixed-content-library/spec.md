# mixed-content-library Specification

## Purpose
Define automatic video movie-vs-series classification behavior that replaces user-selected mixed, movie, and show library semantics in source-first flows.
