---
name: dmux-workflows
description: 使用 dmux（面向 AI agent 的 tmux 面板管理器）进行多 agent 编排。提供跨 Claude Code、Codex、OpenCode 和其他 harness 的并行 agent 工作流模式。适用于并行运行多个 agent 会话或协调多 agent 开发工作流的场景。
---
