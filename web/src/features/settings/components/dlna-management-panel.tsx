        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <FieldGroup>
            ...
            <Field>
              ...
              >
                <SelectTrigger className="w-full border-border/60 bg-background text-foreground md:max-w-xl">
    ...
    <div className="space-y-4">
      <Card className="rounded-[1.5rem] border-border/60 bg-card/80 py-0 shadow-sm backdrop-blur-sm">
        <CardHeader className="flex flex-col gap-4 px-5 py-5 sm:flex-row sm:items-start sm:justify-between">
          <div>
            <CardTitle className="text-xl">自定义配置</CardTitle>
            <CardDescription>
      ...
      <Card className="rounded-[1.5rem] border-border/60 bg-card/80 py-0 shadow-sm backdrop-blur-sm">
        <CardHeader className="px-5 py-5">
          <CardTitle className="text-xl">系统配置</CardTitle>
          <CardDescription>
      ...
      <CardContent className="space-y-6 px-5 py-5">
        <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="flex flex-wrap gap-2">
              {['音频', '照片', '视频'].map((type) => (
                <Badge
                  ...
                  className={
                    profile.mediaTypes.includes(type)
          ...
          <Field>
            ...
            <Input
              defaultValue={profile.maxStreamingQuality}
              className="border-border/60 bg-background text-foreground"
            />
          ...
          <Field>
            ...
            <Input
              defaultValue={profile.musicTranscodeBitrate}
              className="border-border/60 bg-background text-foreground"
            />
