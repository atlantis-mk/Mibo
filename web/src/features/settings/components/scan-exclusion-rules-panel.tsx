...
export function ScanExclusionRulesPanel({ token }: { token: string | null }) {
  ...
  return (
    <section className="rounded-[1.5rem] border border-border/60 bg-gradient-to-br from-card/90 via-card/70 to-emerald-500/5 p-5 shadow-sm backdrop-blur-sm">
        ...
        <div className="space-y-2">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              这些规则会在后续扫描开始时立即生效，用于自动跳过广告或误导入视频。
            </p>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid gap-3 lg:grid-cols-2">
              ...
              <RuleField label="状态">
                ...
                >
                  <NativeSelectOption value="enabled">生效</NativeSelectOption>
