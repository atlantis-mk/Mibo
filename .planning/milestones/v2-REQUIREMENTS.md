...
- [x] **META-01**: 管理员可以编辑标题、原始标题、年份和简介
- [x] **META-02**: 管理员可以编辑海报和背景图
- [x] **META-03**: 管理员可以编辑分类和演员等人物信息
- [x] **META-04**: 管理员可以编辑剧集的季集基础信息
- [x] **META-05**: 管理员可以对媒体条目发起重新匹配
- [x] **META-06**: 管理员可以对媒体条目发起元数据重抓

### Scan Listeners

- [x] **LIST-01**: 系统可以监听存储中的新增、更新、删除和移动类变更
